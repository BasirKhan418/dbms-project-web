...
const Team = () => {
  ...
  <div className="card-body">
    ...
    <p className="card-text">Regd:-220301120231 Sec:-D Group:-3 DBMS</p>
  </div>
</div>
  ...
  <div className="card-body">
    ...
    <p className="card-text">Regd:-220301120197 Sec:-D Group:-3 DBMS</p>
  </div>
</div>
  <div className="card card1 mx-3">
  ...
  <div className="card-body">
    ...
    <p className="card-text">Regd:-220301120200 Sec:-D Group:-3 DBMS</p>
  </div>
</div>
  <div className="card card1 mx-3">
  ...
  <div className="card-body">
    ...
    <p className="card-text">Regd:-220301120232 Sec:-D Group:-3 DBMS</p>
  </div>
</div>
  <div className="card card1 mx-3">
  ...
  <div className="card-body">
    ...
    <p className="card-text">Regd:-220301120209 Sec:-D Group:-3 DBMS</p>
  </div>
</div>
